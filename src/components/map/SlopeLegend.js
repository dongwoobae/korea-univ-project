...
export default function SlopeLegend({ show, isMobile }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 10, fontWeight: 600, color: "#dc2626", marginBottom: 4 }}>▲ 오르막</div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "4px 0 6px" }}>
        <div style={{ width: 24, height: 4, background: "#9ca3af", borderRadius: 2, flexShrink: 0 }} />
        <span style={{ fontSize: 11, color: "#444" }}>평지 (±1%)</span>
      </div>

      <div style={{ fontSize: 10, fontWeight: 600, color: "#1d4ed8", marginBottom: 4 }}>▼ 내리막</div>
